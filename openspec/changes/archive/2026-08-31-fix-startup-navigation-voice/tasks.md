...
- [x] **T1 — MainActivity back stack (D1, D5)**
...
- [x] **T3 — Lazy create on first message (D3)**
...
- [x] **T4 — Backup/reinstall sanity (D4)**
...
- [x] **T6 — Trigger from chat mic (D8, D7)**
...
- [x] **T7 — Trigger from assistant long-press (D8, D7)**
...
- [x] `openspec capture --check fix-startup-navigation-voice` passes (canonical spec deltas apply).
- [x] Spec-library diff review for app-shell / conversation-persistence / voice-interaction-ui / chat-ui.