...
static jlong init_whisper_impl(JNIEnv* env, jstring model_path_j, jint n_threads) {
...
static void free_whisper_impl(jlong handle) {
    if (!handle) return;
...
static jstring transcribe_impl(JNIEnv* env, jlong handle, jfloatArray pcm_floats_j, jint n_samples, jstring language_j) {
    if (!handle) {
...
// Support core.voice.stt package
JNIEXPORT jlong JNICALL
Java_dev_loki_android_core_voice_stt_WhisperBridge_nativeInitWhisper(
        JNIEnv* env, jobject /* this */, jstring model_path_j, jint n_threads) {
    return init_whisper_impl(env, model_path_j, n_threads);
}

JNIEXPORT void JNICALL
Java_dev_loki_android_core_voice_stt_WhisperBridge_nativeFreeWhisper(
        JNIEnv* /* env */, jobject /* this */, jlong handle) {
    free_whisper_impl(handle);
}

JNIEXPORT jstring JNICALL
Java_dev_loki_android_core_voice_stt_WhisperBridge_nativeTranscribe(
        JNIEnv* env, jobject /* this */, jlong handle, jfloatArray pcm_floats_j, jint n_samples, jstring language_j) {
    return transcribe_impl(env, handle, pcm_floats_j, n_samples, language_j);
}

// Support legacy voice package
JNIEXPORT jlong JNICALL
